...
**🔗 Live Demo:** [resumeai-sa5g.onrender.com](https://resumeai-sa5g.onrender.com) — click **Explore the demo workspace** on the landing page, no account needed.

> Hosted on Render's free tier, so the first request after idle can take ~30–60s to spin up.
...
- [Live Demo](https://github.com/vaibhavishukla08/ResumeAI#resumeai--resume-screening--candidate-ranking)
- [Quick Start](https://github.com/vaibhavishukla08/ResumeAI#quick-start)
- [The Three Scores](https://github.com/vaibhavishukla08/ResumeAI#the-three-scores)
- [Role Library](https://github.com/vaibhavishukla08/ResumeAI#role-library)
- [Any Profession, Not Just Tech](https://github.com/vaibhavishukla08/ResumeAI#any-profession-not-just-tech)
- [Features](https://github.com/vaibhavishukla08/ResumeAI#features)
- [Tech Stack](https://github.com/vaibhavishukla08/ResumeAI#tech-stack)
- [Optional Integrations](https://github.com/vaibhavishukla08/ResumeAI#optional-integrations)
- [Project Layout](https://github.com/vaibhavishukla08/ResumeAI#project-layout)
- [API Reference](https://github.com/vaibhavishukla08/ResumeAI#api-reference)
- [Security](https://github.com/vaibhavishukla08/ResumeAI#security)
- [Abuse Protection](https://github.com/vaibhavishukla08/ResumeAI#abuse-protection)
- [Deploying](https://github.com/vaibhavishukla08/ResumeAI#deploying)
- [Known Limits](https://github.com/vaibhavishukla08/ResumeAI#known-limits)
- [Sample Data](https://github.com/vaibhavishukla08/ResumeAI#sample-data)
- [License / Notes](https://github.com/vaibhavishukla08/ResumeAI#notes)
...
Then open [**http://localhost:5173**](http://localhost:5173/). The fastest way in is **Explore the demo workspace** — one click, no address to confirm. To get your own workspace instead, create an account; the first account registered becomes the admin.
...
| CSV export                                 | \`=cmd                                   | '/c calc'!A1\` executed on open in Excel |
...
The live demo above runs this exact build on Render.
